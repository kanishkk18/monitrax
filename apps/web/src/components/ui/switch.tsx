...
const switchVariants = cva(
  `
    ...
    disabled:cursor-not-allowed disabled:opacity-50 dark:data-[state=unchecked]:bg-[#333]
...
const switchThumbVariants = cva(
  'pointer-events-none block dark:bg-[#111] w-1/2 h-[calc(100%-4px)] shadow-lg ring-0 transition-transform start-0 data-[state=unchecked]:translate-x-[2px] data-[state=checked]:translate-x-[calc(100%-2px)] rtl:data-[state=unchecked]:-translate-x-[2px] rtl:data-[state=checked]:-translate-x-[calc(100%-2px)]',
  {
    variants: {
      shape: {
        pill: 'rounded-full',
